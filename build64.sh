...
../configure --disable-lib32 --enable-lib64 --with-default-msvcrt=ucrt --enable-wildcard --enable-experimental --disable-dependency-tracking --prefix=$(pwd)/out; checkreturn $?
